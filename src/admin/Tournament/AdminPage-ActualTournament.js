...
const AdminPageActualTournament = () => {
								...
								<div className="admin-tournament-card-box">
									...
									<div className="admin-tournament-data-box">
										<div className="admin-tournament-data">
											<p> Дата/время :</p> <p>{formatDate(tournament.startDate)}</p> | <p>{formatTime(tournament.startDate)}</p>
										</div>
										<div className="admin-tournament-data">
										...
										<div className="admin-tournament-data">
											<p> Max.участ/Участ. : </p> <p> {tournament.maxPlayers} </p>| <p>{tournament.participants.length}</p>
										</div>
...
export default AdminPageActualTournament;